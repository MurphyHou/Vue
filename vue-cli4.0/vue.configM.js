...
const proxyTarget = {
    ...
    test: 'https://ehis-vitality-stg1.health.pingan.com/'
}
...
module.exports = {
    ...
    /*  这个值也可以被设置为空字符串 ('') 或是相对路径 ('./')，这样所有的资源都会被链接为相对路径，这样打出来的包可以被部署在任意路径。
     生产环境要用process.env.NODE_ENV === 'production'配置最好 */
    //publicPath: process.env.NODE_ENV === 'production' ? 'https://cdn-parun.pingan.com/vitality/vitality/biz/shareTicket/' : './',
    publicPath: './', //Test环境
    // 将构建好的文件输出到哪里
    outputDir: "dist",
